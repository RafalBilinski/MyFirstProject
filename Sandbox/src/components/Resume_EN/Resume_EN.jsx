        ...
        <aside className="left-side">
          ...
          <section className="skills">
            ...
            <ul className="skills-list">
              <li className="skills-item">
                Critical Thinking, Root Cause Analisys
              </li>
              <li className="skills-item">
                Statistical analysis of data and business projects
              </li>
          ...
          <section className="widget">
            <a
              ...
              href={CV}
              download="Rafal Bilinski Resume.pdf"
            >
              Download Resume
            </a>
          </section>
          ...
          <section className="rodo">
            <h6>
              ...
              document for realising this recruitment processes and for future
        ...
        <div className="right-side">
          <section className="bio">
            ...
            <p className="bio-about">
              I have been passionate about computers and controllers since I
              ...
              <br />
              My strength is <b> ability to solve problems creatively </b> and
            ...
            <ul>
              <li className="projects-item">
                <span className="accent">
                  <b>Self-made heat pump with full inverter control </b>
                </span>
              </li>
              <li className="projects-item">
                <span className="accent">
                  <b>
                    Platform for service technicians for handling commitions
                  </b>
                </span>
              </li>
          ...
          <section className="jobs">
            ...
            <h3 className="jobs-occupation">
              Automation engineer / analyst / technical advisor <br />
              <span className="accent">
            ...
            <ul className="experience">
              <li className="experience-item">
                Creating an application that helps assigning tasks to service
                technicians
              </li>
              <li className="experience-item">
                Creating an application that helps handling commissions by
                service technicians
              </li>
              <li className="experience-item">
                Development of control algorithms and process optimization
              </li>
              <li className="experience-item">
                Work on data sets from physical sensors and correction of
                software layer errors of BMS controllers
              </li>
              <li className="experience-item">
                Conducting technical and business talks with corporate clients,
                project costing
              </li>
              <li className="experience-item">
            ...
            <h3 className="jobs-occupation">
              Main electrician / automation engineer
              <br />
              <span className="accent">
            ...
            <ul className="experience">
              <li className="experience-item">
                Building projects from scratch: business analysis, setting-up,
                implementation of corrections and as-built documentation
              </li>
              <li className="experience-item">
                Digitalization of data circulation and documentation as well as
                staff training
              </li>
              <li className="experience-item">
                Analysis of data on the operation of refrigeration systems and
                correction of system parameters
              </li>
              <li className="experience-item">
                Coordination of service and logistics activities in the
                Dolnośląskie and Opolskie voivodships
              </li>
              <li className="experience-item">
                Diagnostics and security automation service along with
                monitoring
              </li>
            </ul>
          ...
          <section className="education">
            ...
            <h3 className="education-degree">
              Master's degree - Electrical engineering: Industrial automation
              <br />
              <span className="accent">

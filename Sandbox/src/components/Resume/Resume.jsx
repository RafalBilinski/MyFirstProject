    ...
    <div className="container" id="resume">
      <aside className="left-side">
        ...
        <section className="contacts">
          <div className="boxL"><h2 className="contacts-title">Contact</h2>
          </div>
        ...
        <br/><section className="widget">
          <a className="widget-link" href="./Rafal Bilinski resume.pdf" download="">Download Resume</a>
        </section>
      ...
      <div className="right-side">
        <section className="bio">
          <div className="boxR"><h1 className="bio-title">Rafal Bilinski<br/></h1>
        ...
        {/*<section className="projects">
          ...
          <h2 className="projects-title">Courses and Certificates</h2>
          </div>
        ...
        <section className="jobs">
          <div className="boxR"><h2 className="education-title">Work Expirience</h2>
          </div>
          ...
          <h3 className="jobs-occupation">
            Service technician for refrigeration and household appliances - <span className="accent">Naprawa Urządzeń Chłodniczych Czesław Biliński</span>
          </h3>
        ...
        <section className="education">
          <div className="boxR"><h2 className="education-title">Education</h2>
            </div>
